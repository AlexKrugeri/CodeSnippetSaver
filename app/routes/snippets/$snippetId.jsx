...
export default function SnippetPage() {
  ...
  return (
    <div className="md:flex w-full">
      <div className="md:w-1/3 lg:w-1/4 grow md:mr-6">
        ...
        <Link to={`edit`}>
        <button
            className="flex items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-1/2 px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 max-w-md mb-6"
            type="submit"
          >
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
        ...
        <Form method="post" className="">
          <button
            className="flex items-center text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-1/2 px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800 max-w-md mb-6"
            type="submit"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
